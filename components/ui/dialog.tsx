...
import { shouldPreventDialogDismiss } from "@/lib/utils/radix-overlay";

function preventCloseOnPortaledOverlay(
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /** Evita cerrar al clicar fuera (Select/Popover portaleados, doble clic, etc.). */
